...
public class AutoFlowLayout <T> extends ViewGroup  {
            ...
            for (int j = 0; j < mColumnNumbers; j++) {
                ...
                if (child != null) {
                    ...
                    if (child.getVisibility() != View.GONE) {
                        setChildClickOperation(child,mCurrentItemIndex);
     ...
     * @param child
     */
    private void setChildClickOperation(View child,final int position) {
        ...
        child.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                if (mOnLongItemClickListener != null) {
                    mOnLongItemClickListener.onLongItemClick(view,position,mAdapter.getItem(position));
                    return true;
                }
                return false;
            }
        ...
        child.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(view,position,mAdapter.getItem(position));
                }
            }
        });
    }
    ...
    public interface OnLongItemClickListener<T>{
        void onLongItemClick(View view,int position,T item);
    }
